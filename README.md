...
+ 二叉树遍历
  + [94. 二叉树的中序遍历](code/94.%20二叉树的中序遍历.md)
    [144. 二叉树的前序遍历](code/144.%20二叉树的前序遍历.md)
    [145. 二叉树的后序遍历](code/145.%20二叉树的后序遍历.md)
  ...
  + [236. 二叉树的最近公共祖先](code/236.%20二叉树的最近公共祖先.md) 递归
  + [543. 二叉树的直径](code/543.%20二叉树的直径.md)
  + [538. 把二叉搜索树转换为累加树](code/538.%20把二叉搜索树转换为累加树.md)
  + [117. 填充每个节点的下一个右侧节点指针 II](code/117.%20填充每个节点的下一个右侧节点指针%20II.md) 层序遍历
+ 二叉搜索树 BST
  + [235. 二叉搜索树的最近公共祖先](code/235.%20二叉搜索树的最近公共祖先.md)
  + [501. 二叉搜索树中的众数](code/501.%20二叉搜索树中的众数.md) BST的中序遍历
  + [530. 二叉搜索树的最小绝对差](code/530.%20二叉搜索树的最小绝对差.md) BST的中序遍历
  + [783. 二叉搜索树节点最小距离](code/783.%20二叉搜索树节点最小距离.md) 和 530 一样
+ 二叉树和链表
...
+ 二分
  ...
  + [34. 在排序数组中查找元素的第一个和最后一个位置](code/34.%20在排序数组中查找元素的第一个和最后一个位置.md)
  + [153. 寻找旋转排序数组中的最小值](code/153.%20寻找旋转排序数组中的最小值.md) m>r l=m+1 r=m
...
+ DFS
  + [329. 矩阵中的最长递增路径](code/329.%20矩阵中的最长递增路径.md) 带记录的DFS **BFS会慢一点**
...
+ 全排列-回溯
  ...
  + [31. 下一个排列](code/31.%20下一个排列.md) 下一个全排列支持重复元素
  + [39. 组合总和](code/39.%20组合总和.md)
  + [40. 组合总和 II](code./)
  + [46. 全排列](code/46.%20全排列.md)
  + [47. 全排列 II](code/47.%20全排列%20II.md)
  + [60. 第k个排列](code/60.%20第k个排列.md) 递归+剪枝
  + [78. 子集](code/78.%20子集.md)
  + [90. 子集 II](code/90.%20子集%20II.md)
...
[55. 跳跃游戏](code/55.%20跳跃游戏.md)
[1024. 视频拼接](code/1024.%20视频拼接.md)
